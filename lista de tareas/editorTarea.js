...
function editorTarea(i, tareas)
{
    ...
    let nuevoEstado = prompt("Ingrese el nuevo estado ([1] pendiente, [2] en curso, [3] terminada) o deje vacío para no cambiar: ");
    let nuevoVencimiento = prompt("Ingrese la nueva fecha de vencimiento (ej: 2025-09-30) o deje vacío para no cambiar: ");
    let nuevaDificultad = parseInt(prompt("Ingrese nueva dificultad (1=fácil, 2=medio, 3=difícil) o deje vacío para no cambiar: "));
